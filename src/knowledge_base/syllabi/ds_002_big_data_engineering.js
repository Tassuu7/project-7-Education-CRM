...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: DS-002
...
const SYLLABUS_DEFINITION = {
  courseCode: 'DS-002',
  courseTitle: 'Big Data Engineering in Data Science',
  academicCredits: 4,
  prerequisites: ['DS-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Big Data Engineering.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Big Data Engineering.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Big Data Engineering', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Big Data Engineering', labExercise: 'Performance Profiling & Bottleneck Elimination' },
