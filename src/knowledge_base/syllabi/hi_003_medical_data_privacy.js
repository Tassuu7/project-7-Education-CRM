...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: HI-003
 * Discipline: Health Informatics
 * Subject: Medical Data Privacy
 * ============================================================================
 */

const SYLLABUS_DEFINITION = {
  courseCode: 'HI-003',
  courseTitle: 'Medical Data Privacy in Health Informatics',
  academicCredits: 4,
  prerequisites: ['HI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Medical Data Privacy.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Medical Data Privacy.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Medical Data Privacy', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Medical Data Privacy', labExercise: 'Performance Profiling & Bottleneck Elimination' },
