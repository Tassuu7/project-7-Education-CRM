...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: BA-005
...
const SYLLABUS_DEFINITION = {
  courseCode: 'BA-005',
  courseTitle: 'Organizational Behavior in Business Administration',
  academicCredits: 4,
  prerequisites: ['BA-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Organizational Behavior.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Organizational Behavior.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Organizational Behavior', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Organizational Behavior', labExercise: 'Performance Profiling & Bottleneck Elimination' },
