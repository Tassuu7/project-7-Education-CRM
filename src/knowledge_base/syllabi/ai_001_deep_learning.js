...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: AI-001
...
const SYLLABUS_DEFINITION = {
  courseCode: 'AI-001',
  courseTitle: 'Deep Learning in Artificial Intelligence',
  academicCredits: 4,
  prerequisites: ['AI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Deep Learning.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Deep Learning.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Deep Learning', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Deep Learning', labExercise: 'Performance Profiling & Bottleneck Elimination' },
