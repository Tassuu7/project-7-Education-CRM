...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: CS-005
...
const SYLLABUS_DEFINITION = {
  courseCode: 'CS-005',
  courseTitle: 'Compiler Design in Computer Science',
  academicCredits: 4,
  prerequisites: ['CS-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Compiler Design.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Compiler Design.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Compiler Design', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Compiler Design', labExercise: 'Performance Profiling & Bottleneck Elimination' },
