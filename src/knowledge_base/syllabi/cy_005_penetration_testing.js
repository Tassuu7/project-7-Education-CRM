...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: CY-005
...
const SYLLABUS_DEFINITION = {
  courseCode: 'CY-005',
  courseTitle: 'Penetration Testing in Cybersecurity',
  academicCredits: 4,
  prerequisites: ['CY-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Penetration Testing.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Penetration Testing.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Penetration Testing', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Penetration Testing', labExercise: 'Performance Profiling & Bottleneck Elimination' },
