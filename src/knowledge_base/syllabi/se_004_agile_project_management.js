...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: SE-004
...
const SYLLABUS_DEFINITION = {
  courseCode: 'SE-004',
  courseTitle: 'Agile Project Management in Software Engineering',
  academicCredits: 4,
  prerequisites: ['SE-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Agile Project Management.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Agile Project Management.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Agile Project Management', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Agile Project Management', labExercise: 'Performance Profiling & Bottleneck Elimination' },
