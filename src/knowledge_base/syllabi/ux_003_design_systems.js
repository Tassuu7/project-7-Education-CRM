...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: UX-003
...
const SYLLABUS_DEFINITION = {
  courseCode: 'UX-003',
  courseTitle: 'Design Systems in Design & Interaction',
  academicCredits: 4,
  prerequisites: ['UX-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Design Systems.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Design Systems.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Design Systems', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Design Systems', labExercise: 'Performance Profiling & Bottleneck Elimination' },
