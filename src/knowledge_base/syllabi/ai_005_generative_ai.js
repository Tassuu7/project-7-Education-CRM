...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: AI-005
...
const SYLLABUS_DEFINITION = {
  courseCode: 'AI-005',
  courseTitle: 'Generative AI in Artificial Intelligence',
  academicCredits: 4,
  prerequisites: ['AI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Generative AI.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Generative AI.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Generative AI', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Generative AI', labExercise: 'Performance Profiling & Bottleneck Elimination' },
