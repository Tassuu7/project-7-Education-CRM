...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: UX-006
...
const SYLLABUS_DEFINITION = {
  courseCode: 'UX-006',
  courseTitle: 'Information Architecture in Design & Interaction',
  academicCredits: 4,
  prerequisites: ['UX-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Information Architecture.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Information Architecture.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Information Architecture', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Information Architecture', labExercise: 'Performance Profiling & Bottleneck Elimination' },
