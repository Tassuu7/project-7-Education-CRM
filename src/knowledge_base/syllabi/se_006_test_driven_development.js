...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: SE-006
...
const SYLLABUS_DEFINITION = {
  courseCode: 'SE-006',
  courseTitle: 'Test Driven Development in Software Engineering',
  academicCredits: 4,
  prerequisites: ['SE-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Test Driven Development.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Test Driven Development.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Test Driven Development', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Test Driven Development', labExercise: 'Performance Profiling & Bottleneck Elimination' },
