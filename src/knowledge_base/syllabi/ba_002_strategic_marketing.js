...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: BA-002
...
const SYLLABUS_DEFINITION = {
  courseCode: 'BA-002',
  courseTitle: 'Strategic Marketing in Business Administration',
  academicCredits: 4,
  prerequisites: ['BA-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Strategic Marketing.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Strategic Marketing.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Strategic Marketing', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Strategic Marketing', labExercise: 'Performance Profiling & Bottleneck Elimination' },
