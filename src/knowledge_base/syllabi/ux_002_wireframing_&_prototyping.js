...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: UX-002
 * Discipline: Design & Interaction
 * Subject: Wireframing & Prototyping
 * ============================================================================
 */

const SYLLABUS_DEFINITION = {
  courseCode: 'UX-002',
  courseTitle: 'Wireframing & Prototyping in Design & Interaction',
  academicCredits: 4,
  prerequisites: ['UX-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Wireframing & Prototyping.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Wireframing & Prototyping.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Wireframing & Prototyping', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Wireframing & Prototyping', labExercise: 'Performance Profiling & Bottleneck Elimination' },
