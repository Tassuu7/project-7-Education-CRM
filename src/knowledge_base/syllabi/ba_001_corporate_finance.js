...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: BA-001
...
const SYLLABUS_DEFINITION = {
  courseCode: 'BA-001',
  courseTitle: 'Corporate Finance in Business Administration',
  academicCredits: 4,
  prerequisites: ['BA-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Corporate Finance.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Corporate Finance.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Corporate Finance', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Corporate Finance', labExercise: 'Performance Profiling & Bottleneck Elimination' },
