...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: AI-003
...
const SYLLABUS_DEFINITION = {
  courseCode: 'AI-003',
  courseTitle: 'Computer Vision in Artificial Intelligence',
  academicCredits: 4,
  prerequisites: ['AI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Computer Vision.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Computer Vision.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Computer Vision', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Computer Vision', labExercise: 'Performance Profiling & Bottleneck Elimination' },
