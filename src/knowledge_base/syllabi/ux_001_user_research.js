...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: UX-001
...
const SYLLABUS_DEFINITION = {
  courseCode: 'UX-001',
  courseTitle: 'User Research in Design & Interaction',
  academicCredits: 4,
  prerequisites: ['UX-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in User Research.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in User Research.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of User Research', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in User Research', labExercise: 'Performance Profiling & Bottleneck Elimination' },
