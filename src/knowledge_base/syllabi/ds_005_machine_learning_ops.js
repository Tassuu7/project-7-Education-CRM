...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: DS-005
 * Discipline: Data Science
 * Subject: Machine Learning Ops
 * ============================================================================
 */

const SYLLABUS_DEFINITION = {
  courseCode: 'DS-005',
  courseTitle: 'Machine Learning Ops in Data Science',
  academicCredits: 4,
  prerequisites: ['DS-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Machine Learning Ops.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Machine Learning Ops.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Machine Learning Ops', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Machine Learning Ops', labExercise: 'Performance Profiling & Bottleneck Elimination' },
