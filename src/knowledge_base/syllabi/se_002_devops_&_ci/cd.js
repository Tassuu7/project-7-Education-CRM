...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: SE-002
...
const SYLLABUS_DEFINITION = {
  courseCode: 'SE-002',
  courseTitle: 'DevOps & CI/CD in Software Engineering',
  academicCredits: 4,
  prerequisites: ['SE-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in DevOps & CI/CD.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in DevOps & CI/CD.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of DevOps & CI/CD', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in DevOps & CI/CD', labExercise: 'Performance Profiling & Bottleneck Elimination' },
