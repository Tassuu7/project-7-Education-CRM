...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: HI-001
 * Discipline: Health Informatics
 * Subject: Clinical Information Systems
 * ============================================================================
 */

const SYLLABUS_DEFINITION = {
  courseCode: 'HI-001',
  courseTitle: 'Clinical Information Systems in Health Informatics',
  academicCredits: 4,
  prerequisites: ['HI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Clinical Information Systems.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Clinical Information Systems.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Clinical Information Systems', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Clinical Information Systems', labExercise: 'Performance Profiling & Bottleneck Elimination' },
