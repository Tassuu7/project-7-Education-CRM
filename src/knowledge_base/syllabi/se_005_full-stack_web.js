...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: SE-005
...
const SYLLABUS_DEFINITION = {
  courseCode: 'SE-005',
  courseTitle: 'Full-Stack Web in Software Engineering',
  academicCredits: 4,
  prerequisites: ['SE-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Full-Stack Web.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Full-Stack Web.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Full-Stack Web', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Full-Stack Web', labExercise: 'Performance Profiling & Bottleneck Elimination' },
