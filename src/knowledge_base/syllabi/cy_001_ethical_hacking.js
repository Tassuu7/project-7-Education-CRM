...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: CY-001
...
const SYLLABUS_DEFINITION = {
  courseCode: 'CY-001',
  courseTitle: 'Ethical Hacking in Cybersecurity',
  academicCredits: 4,
  prerequisites: ['CY-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Ethical Hacking.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Ethical Hacking.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Ethical Hacking', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Ethical Hacking', labExercise: 'Performance Profiling & Bottleneck Elimination' },
