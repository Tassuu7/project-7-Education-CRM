...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: HI-005
 * Discipline: Health Informatics
 * Subject: Telemedicine Systems
 * ============================================================================
 */

const SYLLABUS_DEFINITION = {
  courseCode: 'HI-005',
  courseTitle: 'Telemedicine Systems in Health Informatics',
  academicCredits: 4,
  prerequisites: ['HI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Telemedicine Systems.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Telemedicine Systems.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Telemedicine Systems', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Telemedicine Systems', labExercise: 'Performance Profiling & Bottleneck Elimination' },
