...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: BA-003
...
const SYLLABUS_DEFINITION = {
  courseCode: 'BA-003',
  courseTitle: 'Operations Management in Business Administration',
  academicCredits: 4,
  prerequisites: ['BA-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Operations Management.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Operations Management.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Operations Management', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Operations Management', labExercise: 'Performance Profiling & Bottleneck Elimination' },
