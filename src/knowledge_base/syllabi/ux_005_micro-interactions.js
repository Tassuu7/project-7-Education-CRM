...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: UX-005
 * Discipline: Design & Interaction
 * Subject: Micro-Interactions
 * ============================================================================
 */

const SYLLABUS_DEFINITION = {
  courseCode: 'UX-005',
  courseTitle: 'Micro-Interactions in Design & Interaction',
  academicCredits: 4,
  prerequisites: ['UX-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Micro-Interactions.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Micro-Interactions.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Micro-Interactions', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Micro-Interactions', labExercise: 'Performance Profiling & Bottleneck Elimination' },
