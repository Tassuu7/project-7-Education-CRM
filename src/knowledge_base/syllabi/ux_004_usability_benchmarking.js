...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: UX-004
 * Discipline: Design & Interaction
 * Subject: Usability Benchmarking
 * ============================================================================
 */

const SYLLABUS_DEFINITION = {
  courseCode: 'UX-004',
  courseTitle: 'Usability Benchmarking in Design & Interaction',
  academicCredits: 4,
  prerequisites: ['UX-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Usability Benchmarking.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Usability Benchmarking.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Usability Benchmarking', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Usability Benchmarking', labExercise: 'Performance Profiling & Bottleneck Elimination' },
