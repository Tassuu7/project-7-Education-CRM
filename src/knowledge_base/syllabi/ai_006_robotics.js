...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: AI-006
...
const SYLLABUS_DEFINITION = {
  courseCode: 'AI-006',
  courseTitle: 'Robotics in Artificial Intelligence',
  academicCredits: 4,
  prerequisites: ['AI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Robotics.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Robotics.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Robotics', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Robotics', labExercise: 'Performance Profiling & Bottleneck Elimination' },
