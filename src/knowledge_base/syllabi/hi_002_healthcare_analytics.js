...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: HI-002
...
const SYLLABUS_DEFINITION = {
  courseCode: 'HI-002',
  courseTitle: 'Healthcare Analytics in Health Informatics',
  academicCredits: 4,
  prerequisites: ['HI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Healthcare Analytics.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Healthcare Analytics.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Healthcare Analytics', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Healthcare Analytics', labExercise: 'Performance Profiling & Bottleneck Elimination' },
