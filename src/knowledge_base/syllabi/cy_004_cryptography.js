...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: CY-004
...
const SYLLABUS_DEFINITION = {
  courseCode: 'CY-004',
  courseTitle: 'Cryptography in Cybersecurity',
  academicCredits: 4,
  prerequisites: ['CY-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Cryptography.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Cryptography.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Cryptography', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Cryptography', labExercise: 'Performance Profiling & Bottleneck Elimination' },
