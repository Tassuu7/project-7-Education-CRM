...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: BA-006
...
const SYLLABUS_DEFINITION = {
  courseCode: 'BA-006',
  courseTitle: 'Executive Leadership in Business Administration',
  academicCredits: 4,
  prerequisites: ['BA-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Executive Leadership.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Executive Leadership.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Executive Leadership', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Executive Leadership', labExercise: 'Performance Profiling & Bottleneck Elimination' },
