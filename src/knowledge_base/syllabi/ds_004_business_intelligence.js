...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: DS-004
...
const SYLLABUS_DEFINITION = {
  courseCode: 'DS-004',
  courseTitle: 'Business Intelligence in Data Science',
  academicCredits: 4,
  prerequisites: ['DS-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Business Intelligence.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Business Intelligence.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Business Intelligence', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Business Intelligence', labExercise: 'Performance Profiling & Bottleneck Elimination' },
