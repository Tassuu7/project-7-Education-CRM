...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: SE-003
...
const SYLLABUS_DEFINITION = {
  courseCode: 'SE-003',
  courseTitle: 'Design Patterns in Software Engineering',
  academicCredits: 4,
  prerequisites: ['SE-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Design Patterns.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Design Patterns.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Design Patterns', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Design Patterns', labExercise: 'Performance Profiling & Bottleneck Elimination' },
