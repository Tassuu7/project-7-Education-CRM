...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: BA-004
...
const SYLLABUS_DEFINITION = {
  courseCode: 'BA-004',
  courseTitle: 'Venture Capital in Business Administration',
  academicCredits: 4,
  prerequisites: ['BA-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Venture Capital.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Venture Capital.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Venture Capital', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Venture Capital', labExercise: 'Performance Profiling & Bottleneck Elimination' },
