...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: AI-002
...
const SYLLABUS_DEFINITION = {
  courseCode: 'AI-002',
  courseTitle: 'Natural Language Processing in Artificial Intelligence',
  academicCredits: 4,
  prerequisites: ['AI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Natural Language Processing.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Natural Language Processing.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Natural Language Processing', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Natural Language Processing', labExercise: 'Performance Profiling & Bottleneck Elimination' },
