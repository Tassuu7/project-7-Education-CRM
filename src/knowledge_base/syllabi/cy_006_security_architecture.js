...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: CY-006
...
const SYLLABUS_DEFINITION = {
  courseCode: 'CY-006',
  courseTitle: 'Security Architecture in Cybersecurity',
  academicCredits: 4,
  prerequisites: ['CY-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Security Architecture.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Security Architecture.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Security Architecture', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Security Architecture', labExercise: 'Performance Profiling & Bottleneck Elimination' },
