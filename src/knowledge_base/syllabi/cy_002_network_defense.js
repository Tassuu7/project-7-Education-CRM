...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: CY-002
...
const SYLLABUS_DEFINITION = {
  courseCode: 'CY-002',
  courseTitle: 'Network Defense in Cybersecurity',
  academicCredits: 4,
  prerequisites: ['CY-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Network Defense.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Network Defense.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Network Defense', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Network Defense', labExercise: 'Performance Profiling & Bottleneck Elimination' },
