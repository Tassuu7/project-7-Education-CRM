...
/**
 * ============================================================================
 * EduPulse Academic Curriculum Syllabus: HI-004
...
const SYLLABUS_DEFINITION = {
  courseCode: 'HI-004',
  courseTitle: 'Biostatistics in Health Informatics',
  academicCredits: 4,
  prerequisites: ['HI-101', 'MATH-201'],
  targetAudience: 'Undergraduate / Postgraduate STEM Students',
  courseOverview: 'An in-depth, rigorous exploration into theoretical foundations, practical applications, and industry-standard best practices in Biostatistics.',
  
  learningOutcomes: [
    'Master core principles, algorithmic paradigms, and implementation techniques in Biostatistics.',
  ...
  weeklyBreakdown: [
    { week: 1, topic: 'Introduction & Foundations of Biostatistics', labExercise: 'Environment Setup and Hello World Benchmark' },
    ...
    { week: 7, topic: 'Advanced Topics in Biostatistics', labExercise: 'Performance Profiling & Bottleneck Elimination' },
