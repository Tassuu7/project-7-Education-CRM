...
const framework = require('../../../src/knowledge_base/accreditation/framework_013');

describe('Accreditation Framework 013', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_013');
