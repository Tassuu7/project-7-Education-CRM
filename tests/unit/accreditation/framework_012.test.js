...
const framework = require('../../../src/knowledge_base/accreditation/framework_012');

describe('Accreditation Framework 012', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_012');
