...
const framework = require('../../../src/knowledge_base/accreditation/framework_036');

describe('Accreditation Framework 036', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_036');
