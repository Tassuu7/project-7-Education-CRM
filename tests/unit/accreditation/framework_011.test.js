...
const framework = require('../../../src/knowledge_base/accreditation/framework_011');

describe('Accreditation Framework 011', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_011');
