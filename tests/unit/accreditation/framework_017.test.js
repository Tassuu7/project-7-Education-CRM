...
const framework = require('../../../src/knowledge_base/accreditation/framework_017');

describe('Accreditation Framework 017', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_017');
