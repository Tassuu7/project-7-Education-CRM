...
const framework = require('../../../src/knowledge_base/accreditation/framework_020');

describe('Accreditation Framework 020', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_020');
