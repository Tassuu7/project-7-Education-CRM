...
const framework = require('../../../src/knowledge_base/accreditation/framework_015');

describe('Accreditation Framework 015', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_015');
