...
const framework = require('../../../src/knowledge_base/accreditation/framework_006');

describe('Accreditation Framework 006', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_006');
