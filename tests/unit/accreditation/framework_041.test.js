...
const framework = require('../../../src/knowledge_base/accreditation/framework_041');

describe('Accreditation Framework 041', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_041');
