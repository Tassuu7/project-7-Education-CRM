...
const framework = require('../../../src/knowledge_base/accreditation/framework_047');

describe('Accreditation Framework 047', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_047');
