...
const framework = require('../../../src/knowledge_base/accreditation/framework_008');

describe('Accreditation Framework 008', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_008');
