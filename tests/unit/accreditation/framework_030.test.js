...
const framework = require('../../../src/knowledge_base/accreditation/framework_030');

describe('Accreditation Framework 030', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_030');
