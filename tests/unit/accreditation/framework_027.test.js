...
const framework = require('../../../src/knowledge_base/accreditation/framework_027');

describe('Accreditation Framework 027', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_027');
