...
const framework = require('../../../src/knowledge_base/accreditation/framework_018');

describe('Accreditation Framework 018', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_018');
