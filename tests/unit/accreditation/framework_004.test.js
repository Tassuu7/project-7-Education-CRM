...
const framework = require('../../../src/knowledge_base/accreditation/framework_004');

describe('Accreditation Framework 004', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_004');
