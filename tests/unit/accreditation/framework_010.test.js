...
const framework = require('../../../src/knowledge_base/accreditation/framework_010');

describe('Accreditation Framework 010', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_010');
