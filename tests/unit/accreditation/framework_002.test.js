...
const framework = require('../../../src/knowledge_base/accreditation/framework_002');

describe('Accreditation Framework 002', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_002');
