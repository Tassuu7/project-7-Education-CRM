...
const framework = require('../../../src/knowledge_base/accreditation/framework_003');

describe('Accreditation Framework 003', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_003');
