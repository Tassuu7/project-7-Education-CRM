...
const framework = require('../../../src/knowledge_base/accreditation/framework_026');

describe('Accreditation Framework 026', () => {
  it('should have valid framework ID and version', () => {
    assert.strictEqual(framework.frameworkId, 'ACCRED_FW_026');
